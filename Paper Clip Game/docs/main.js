...
function updateSegmentVisibility(){
    ...
    var segmentGroups = [
        {
            segmentId: "segment-computing",
            contentIds: ["compDiv", "swarmEngine", "qComputing"]
        },
        {
            segmentId: "segment-strategy",
            contentIds: ["investmentEngine", "investmentEngineUpgrade", "strategyEngine", "tournamentManagement"]
        },
        {
            segmentId: "segment-conflict",
            contentIds: ["battleCanvasDiv", "honorDiv", "probeDesignDiv"]
        },
        {
            segmentId: "segment-systems",
            contentIds: ["systemControls", "cheatControls"]
        }
    ];

    for (var i = 0; i < segmentGroups.length; i++){
        var group = segmentGroups[i];
        var segmentEl = document.getElementById(group.segmentId);
        ...
        for (var j = 0; j < group.contentIds.length; j++){
            var contentEl = document.getElementById(group.contentIds[j]);
        ...
        segmentEl.style.display = hasVisibleContent ? "" : "none";
    }
}
